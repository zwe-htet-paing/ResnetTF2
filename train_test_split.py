...
class SplitDataset():
    def __init__(self, dataset_dir, saved_dataset_dir, train_ratio=0.6, test_ratio=0.2, show_progress=False):
        ...
        self.train_dir = saved_dataset_dir + '/train/'
        self.valid_dir = saved_dataset_dir + '/valid/'
        self.test_dir = saved_dataset_dir + '/test/'
    ...
    def __get_all_file_path(self):
        all_file_path = []
        index = 0
        for file_type in self.__get_label_name():
    ...
    def start_splitting(self):
        ...
        self.__copy_files(self.train_file_path, self.train_dir)
        self.__copy_files(self.valid_file_path, self.valid_dir)
        self.__copy_files(self.test_file_path, self.test_dir)
